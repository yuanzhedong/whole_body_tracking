...
def large_blocks(here, wr, runset=None):
    ...
    return [
        ...
        wr.MarkdownBlock(text=(
            ...
            "**0.13–0.44 m higher** than the reference — it doesn't reach the very lowest postures (a "
            "genuine model limit, not a pipeline bug; verified disabling domain-randomization doesn't "
            "change it).\n"
